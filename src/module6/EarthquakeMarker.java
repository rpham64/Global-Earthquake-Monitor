...
public abstract class EarthquakeMarker extends CommonMarker implements Comparable<EarthquakeMarker>
{
	...
	// Added in @Override to override compareTo method
	@Override
	public int compareTo(EarthquakeMarker marker) {
		...
		int compare = marker.getTitle().compareTo(this.getTitle());
		return (compare != 0 ? compare : getTitle().compareTo(marker.getTitle()));
	}
